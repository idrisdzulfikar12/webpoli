...
<div class="container-fluid flex flex-col justify-center items-center text-white p-5"
     style="height: 400px; background-image: url('assets/images/POLIKLINIK.png'); background-size: cover; background-position: center; position: relative;">
</h5>
    <marquee direction="left" scrollamount="12" style="position: absolute; bottom: 0; background-color: rgba(0,0,0,0.5); color: white; width: 100%; padding: 10px;">
        Selamat Datang | Jaga Kesehatan
    </marquee>
</div>
    ...
    <div class="container">
        ...
        <!-- Customer 1 -->
        <div class="testimonial-card my-0">
            <div class="card">
